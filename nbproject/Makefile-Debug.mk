...
LDLIBSOPTIONS=/usr/lib/x86_64-linux-gnu/libcurl.so.3

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ftpclient

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ftpclient: /usr/lib/x86_64-linux-gnu/libcurl.so.3
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/curl/tests/newcunittest.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/curl/tests/newcunittest.o: curl/tests/newcunittest.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I. -MMD -MP -MF $@.d -o ${TESTDIR}/curl/tests/newcunittest.o curl/tests/newcunittest.c
